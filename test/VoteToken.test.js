...
contract('VoteToken', function ([_, owner, recipient, anotherAccount]) {
  const ZERO_ADDRESS = '0x0000000000000000000000000000000000000000';

  beforeEach(async function () {
    this.token = await VoteToken.new(owner);
  });
  ...
  describe('transfer', function () {
    ...
    describe('when the recipient is the zero address', function () {
      ...
      it('reverts', async function () {
        await assertRevert(this.token.transfer(to, 200000000000, { from: owner }));
      });
    });
  });
  ...
  describe('transfer from', function () {
    ...
    describe('when the recipient is not the zero address', function () {
      ...
      describe('when the spender has enough approved balance', function () {
        beforeEach(async function () {
          await this.token.approve(spender, 200000000000, { from: owner });
        });
      ...
      describe('when the spender does not have enough approved balance', function () {
        beforeEach(async function () {
          await this.token.approve(spender, 199999999999, { from: owner });
        });
